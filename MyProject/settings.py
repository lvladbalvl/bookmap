...
SECRET_KEY = 'n&r_^7_$+)klx)@ur$*=$@kufsx2pj!nq2l+lh_+og!$5jok06'
...
LOGIN_REDIRECT_URL = '/page/bookmap/'
LOGIN_URL = '/page/accounts/registration/login'
DATABASES = {
    'default': {
...
# MEDIA_ROOT = 'C:\\Users\\Vlad\\Documents\\django_test\\MyProject\\page\\media'
# MEDIA_URL = "/media/"